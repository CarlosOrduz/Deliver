	...
	return Controller.extend("sap.m.sample.SinglePlanningCalendar.Page", {
		...
		onInit: function() {
			...
			oModel.setData({
					...
					appointments: [{
						...
						startDate: new Date("2020", "11", "11", "5", "0"),
						endDate: new Date("2020", "11", "11", "6", "0")
					}, {
						title: "Discussion of the plan",
						type: CalendarDayType.Type01,
						startDate: new Date("2020", "11", "11", "6", "0"),
						endDate: new Date("2020", "11", "11", "7", "9")
					}, {
						title: "Lunch",
						text: "canteen",
						type: CalendarDayType.Type05,
				...
				supportedAppointmentItems: [
					...
					{
						text: "Discusion de Operacion",
						type: CalendarDayType.Type08
					},
					{
						text: "Fuera de la Oficina",
						type: CalendarDayType.Type09
					},
					{
						text: "Reunion Privada",
						type: CalendarDayType.Type03
					}
				]
			});
		...
		handleAppointmentSelect: function (oEvent) {
			...
			if (!this._oDetailsPopover) {
				Fragment.load({
					id: "popoverFrag",
					name: "com.sap.build.standard.essenttia.view.Details",
					controller: this
				})
		...
		_arrangeDialogFragment: function (sTitle) {
			if (!this._oNewAppointmentDialog) {
				Fragment.load({
					id: "dialogFrag",
					name: "com.sap.build.standard.essenttia.view.Modify",
					controller: this
				})
		...
		handleOpenLegend: function (oEvent) {
			...
			if (!this._oLegendPopover) {
				Fragment.load({
					id: "LegendFrag",
					name: "com.sap.build.standard.essenttia.view.Legend",
					controller: this
				}).then(function(oPopoverContent){
