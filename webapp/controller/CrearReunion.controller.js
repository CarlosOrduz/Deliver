...
], function (BaseController, MessageBox, D0_1464182097909, Utilities, History) {
	"use strict";

	return BaseController.extend("com.sap.build.standard.essenttia.controller.CrearReunion", {
		handleRouteMatched: function (oEvent) {
			...
			if (!this.sContext) {
				this.sContext = "TimeSheetModelSet('1')";
			}
				...
				.then(function (result) {
					if (result === false) {
						...
						return new Promise(function (fnResolve) {
							...
							sap.m.MessageToast.show("Se ha creado la reunión", {
								onClose: fnResolve,
								duration: 4000 || 3000,
								at: sTargetPos,
								my: sTargetPos
		...
		_onButtonPress: function (oEvent) {
			...
			var sDialogName = "D0_1464182097909";
			this.mDialogs = this.mDialogs || {};
			var oDialog = this.mDialogs[sDialogName];
			if (!oDialog) {
				oDialog = new D0_1464182097909(this.getView());
		...
		onInit: function () {
			...
			this.oRouter.getTarget("CrearReunion").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
